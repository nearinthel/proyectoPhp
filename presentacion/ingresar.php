    ...
    if(!isset($_COOKIE['reg'])){
        if(isset($_POST['check'])){
            ...
            if($func->getPass() == $passi){
                setcookie("reg",$passi,time() + 600 , "/");//hay que vichar el path (86400 * 30)eso es un mes
            }
        }
    }
?>
...
<body>
    ...
    if($func->getPass() == $passi){
        ...
        echo "<li class=".'"nav-item"'.">
                <a class=".'"nav-link"'. "href=".'"#"'.">Ver el recibo de sueldo</a></li>";
        echo "<li class=".'"nav-item"'.">
                <button class=".'"nav-link"'. "href=".'"#"'.">Logout</a></li></ul>";
    }else{
