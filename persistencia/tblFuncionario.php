...
class tblFuncionario {
    ...
    public function updateFun($ci ,$registro, $nombre, $apellido,$mail, 
        ...
        $sql="update funcionario set registro='$registro', nombre='$nombre', apellido='$apellido',mail='$mail' ,"
                . "cargo='$cargo', sueldo='$sueldo' , esSubordinado='$esSubordinado', "
                . "esSupervisor='$esSupervisor', esJefe='$esJefe' where registro= '$ci' ";
        return $sql;
    }
    ...
    public function updateTieneSupervisor($ci , $reg){
    
        $sql="update tiene set regSup='$ci' where regSup='$reg'";
        return $sql;
    }
    
    
    public function updateTieneSubordinado($ci, $reg){
        $sql="update tiene set regSub='$ci' where regSub='$reg'";
        return $sql;
